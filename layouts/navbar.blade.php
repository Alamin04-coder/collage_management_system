...
<nav class="navbar navbar-expand-lg navbar-custom">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            ...
            <ul class="navbar-nav ms-auto">
                <li class="nav-item">
                    ...
                    <a class="nav-link active object-fit-cover" aria-current="page" href="{{route('admin.dashboard')}}">Home</a>
                ...
                <li class="nav-item dropdown">
                     <a class="nav-link dropdown-toggle d-flex align-items-center" href="#" id="profileDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                        @php
                            ...
                            if($role === 'student' && isset($student) && $student->image) {
                                $image = asset('student_images/'.$student->image);
                            } elseif($role === 'teacher' && isset($teacher) && $teacher->image) {
                                $image = asset('teacher_images/'.$teacher->image);
                            } elseif($role === 'admin') {
                                $image = asset('images/admin.jpg');
                            }
                        @endphp
                        <img src="{{ $image }}" alt="Profile Image" class="rounded-circle me-2" width="35" height="35">
                    </a>
    ...
    <form id="logout-form1" action="{{ route('admin.logout') }}" method="POST" class="d-none">@csrf</form>
